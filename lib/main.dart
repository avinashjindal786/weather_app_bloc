...
import 'package:weather_app_bloc/weather_bloc.dart';
import 'package:weather_app_bloc/weather_event.dart';
import 'package:weather_app_bloc/weather_state.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(create: (context)=>WeatherBloc(WeatherRepo()),child: MaterialApp(
